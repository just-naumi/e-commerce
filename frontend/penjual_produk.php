      ...
      <div class="table-wrap">
        <table id="tbl">
          ...
          <tr data-name="<?=strtolower(htmlspecialchars($p['nama_barang']))?>">
            ...
            <td><?php if(!empty($p['foto_barang'])):?><img src="<?=$base_url?>/uploads/<?=htmlspecialchars($p['foto_barang'])?>" class="thumb" onerror="this.style.display='none'"><?php else:?><div class="thumb-ph"><i class="fas fa-image"></i></div><?php endif;?></td>
